...
class Ayat extends Component {
  ...
  componentDidMount() {
    fetch(
      `http://api.alquran.cloud/v1/surah/${this.props.match.params.number}/en.transliteration`
    )
      .then((res) => res.json())
      .then((res) => {
        this.setState({
        ...
        fetch(
          `http://api.alquran.cloud/v1/surah/${this.props.match.params.number}`
        )
          .then((res) => res.json())
          .then((res) => {
            this.setState({
  ...
  handleTranslate = (event) => {
    ...
    fetch(
      `http://api.alquran.cloud/v1/surah/${this.props.match.params.number}/${event.target.dataset.id}`
    )
      .then((res) => res.json())
      .then((res) => {
        this.setState(
